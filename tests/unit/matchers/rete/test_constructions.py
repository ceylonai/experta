...
def test_self_referencing_fact():
    from expert_ceylon import KnowledgeEngine, Rule, Fact, W
...
def test_or_with_multiple_nots_get_multiple_activations():
    from expert_ceylon import KnowledgeEngine, Rule, Fact
...
def test_initial_not_vs_and_not():
    from expert_ceylon import KnowledgeEngine, Rule, Fact, DefFacts
...
def test_TEST_1():
    ...
    from expert_ceylon import KnowledgeEngine, Rule, Fact, TEST, W
...
def test_EXISTS_1():
    from expert_ceylon import KnowledgeEngine, Rule, Fact, EXISTS
...
def test_FORALL_1():
    from expert_ceylon import KnowledgeEngine, Rule, Fact, FORALL, W
...
def test_OR_not_allow_inside_FORALL_nor_EXISTS():
    from expert_ceylon import KnowledgeEngine, Fact, Rule, FORALL, EXISTS, OR
...
def test_ANDNOT_reactivation():
    from expert_ceylon import KnowledgeEngine, Fact, Rule, NOT, W
...
def test_OR_inside_Rule():
    from expert_ceylon import KnowledgeEngine, OR, Fact, Rule
...
def test_nested_values_dict():
    from expert_ceylon import KnowledgeEngine, Fact, Rule
