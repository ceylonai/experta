...
def test_or_inside_and():
    from expert_ceylon import Fact, Rule, AND, OR
...
def test_and_inside_and():
    from expert_ceylon import Fact, Rule, AND
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_or_inside_or():
    from expert_ceylon import Fact, Rule, OR
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_or_and_fact_inside_or():
    from expert_ceylon import Fact, OR, Rule
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_or_inside_or_inside_and():
    from expert_ceylon import Fact, OR, AND, Rule
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_or_inside_fact():
    from expert_ceylon import Fact, OR, Rule, L
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_not_or_inside_fact():
    from expert_ceylon import Fact, OR, Rule, L
    from expert_ceylon.fieldconstraint import ANDFC, NOTFC
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_and_inside_and_inside_fact():
    from expert_ceylon import Fact, OR, Rule, L
    from expert_ceylon.fieldconstraint import ANDFC
    from expert_ceylon.matchers.rete.dnf import dnf
...
def test_multiple_or_inside_rule():
    from expert_ceylon import Fact, OR, Rule, AND
    from expert_ceylon.matchers.rete.dnf import dnf
