...
def test_featurecheck_exists():
    try:
        from expert_ceylon.matchers.rete.check import FeatureCheck
...
def test_featurecheck_call_literal():
    from expert_ceylon.matchers.rete.check import FeatureCheck
    from expert_ceylon import L, Fact
...
def test_featurecheck_call_wildcard():
    from expert_ceylon.matchers.rete.check import FeatureCheck
    from expert_ceylon import W, Fact
...
def test_featurecheck_call_predicate():
    from expert_ceylon.matchers.rete.check import FeatureCheck
    from expert_ceylon import P, Fact
...
def test_featurecheck_call_and():
    from expert_ceylon.matchers.rete.check import FeatureCheck
    from expert_ceylon import L, P, W, Fact
